...
from twobit.twisted_gitpoller import GitHubOrgRepoPollerService

""" Test TAC file / program to exercise the GitHubOrgRepoPollerService
"""
...
poller = poller_factory.make_poller(config_dict = config_dict,
                                    callback = mycallback)
service = GitHubOrgRepoPollerService(poller = poller,
